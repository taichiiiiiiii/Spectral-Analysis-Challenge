...
class TestMMDSelection:
    ...
    def test_compute_mmd(self):
        """MMD計算が正しいこと"""
        from src.preprocessing.issue46_mmd_selection import compute_prediction_mmd
        np.random.seed(42)
    ...
    def test_select_best_preprocessing(self, domain_data):
        """最適前処理が選択されること"""
        from src.preprocessing.issue46_mmd_selection import select_best_preprocessing
